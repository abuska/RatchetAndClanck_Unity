...
public class EnemyBulletScript : MonoBehaviour
{
    ...
    [
        Tooltip(
            "Prefab of wall damange hit. The object needs 'LevelPart' tag to create decal on it.")
    ]
    ...
    [
        Tooltip(
            "Blood prefab particle this bullet will create upoon hitting enemy")
    ]
        ...
        )
        {
            if (decalHitWall || true)
            {
                ...
                if (hit.transform.tag == "Player")
                {
                    ...
                    Player.GetComponent<PlayerStats>().DecreaseHealth(10);
